...
@Command(scope = "nec-ic", name = "run-workflow", description = "Run NEC ID Check Workflow")
public class RunNECIDCheckWorkflowAction extends AbstractAction {
    ...
    public RunNECIDCheckWorkflowAction() {
        super();
    }
