...
public class NECIdentityCheckMessagingService {

    private final Logger logger = LoggerFactory.getLogger(NECIdentityCheckMessagingService.class);
    ...
    public NECIdentityCheckMessagingService() {
        super();
    }
    ...
    public void start() throws Exception {
        ...
        NECIdentityCheckMessageListener messageListener = new NECIdentityCheckMessageListener();
